...
from config.auth import get_current_professor, get_password_hash, verify_password
from models import Professor, Course, Student, student_course_association, User
